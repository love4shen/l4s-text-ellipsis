...
An element provides similar functionality to css `text-overflow: ellipsis;`, but supports multi-line paragraph
...
1. get current height of the container (custom element), of the header, of the content and check if ellipsis is required
2. if yes, remove one word at a time and set textContent until the heights fit, and i know it's expansive :(
3. reset content on resize and run the algorithm again, again it's sooooo expansive

Better algorithm welcome!
